...
public class OpenLocalMapUtil {
     ...
     */
    public static String getBaiduMapUri(String originLat, String originLon,  String desLat, String desLon, String destination, String region, String src){
        ...
        return String.format(uri, originLat, originLon,  desLat, desLon, destination, region, src);
    }
